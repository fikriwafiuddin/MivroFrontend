    ...
    render: (row, actions) => (
      <div className="flex gap-2">
        <button
          ...
          className="bg-blue-100 p-1 text-blue-600 hover:text-blue-900"
        >
          <svg
        ...
        <button
          ...
          className="bg-red-100 p-1 text-red-600 hover:text-red-900 ml-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export const tabs = ["category", "transactions"]
